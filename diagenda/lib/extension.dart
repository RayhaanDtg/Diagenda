...
extension ImportanceLevelColorReversed on Color {
  static final colorLevelsRevered = {
    const Color.fromRGBO(51, 243, 33, 1): ImportanceLevel.Low,
    const Color.fromRGBO(243, 242, 33, 1): ImportanceLevel.Medium,
    const Color.fromRGBO(243, 146, 33, 1): ImportanceLevel.High,
    const Color.fromRGBO(235, 12, 16, 1): ImportanceLevel.Critical
  };
  ImportanceLevel? get importanceColorReversed => colorLevelsRevered[this];
}

extension ImportanceLevelColor on ImportanceLevel {
  static const colorLevels = {
    ImportanceLevel.Low: Color.fromRGBO(51, 243, 33, 1),
    ImportanceLevel.Medium: Color.fromRGBO(243, 242, 33, 1),
    ImportanceLevel.High: Color.fromRGBO(243, 146, 33, 1),
    ImportanceLevel.Critical: Color.fromRGBO(235, 12, 16, 1)
  };

  Color? get importanceColor => colorLevels[this];
}
